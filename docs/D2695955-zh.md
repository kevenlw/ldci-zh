...
版本时间: 2017-06-28 14:34:35 <br>
在此查看: [https://dcmi.github.io/ldci/D2695955/](https://dcmi.github.io/ldci/D2695955/) <br>
...
* [B:](http://asn.desire2learn.com/resources/S2696001) RDF中的识别
    * [C:](http://asn.desire2learn.com/resources/S2731548) 知道在RDF中所有东西（thing）通过唯一资源识别符URIs进行命名，例如，代理、地点、事件、物件与概念等。
    * [C:](http://asn.desire2learn.com/resources/S2742438) 了解现实世界中的事物可能需要通过URI来命名，这与关于事物的信息的URI并不是一回事。
    * [C:](http://asn.desire2learn.com/resources/S2742439) R辨认URIs的归属，通过互联网域名的所有者来判断。
